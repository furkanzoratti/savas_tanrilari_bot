export const RESOURCES = {
  ...
  IRON: { label: "Demir", effects: ["Mızraklı, Ağır Piyade ve Ağır Süvari yetiştirme maliyeti -%10", "Koçbaşı, Katapult, Mancınık ve Balista üretim maliyeti -%10"] },
  ...
  LEAD: { label: "Kurşun", effects: ["Sapancı yetiştirme maliyeti -%10", "Mancınık ve Balista üretim maliyeti -%10"] },
