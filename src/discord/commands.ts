...
export const commandBuilders = [
  new SlashCommandBuilder()
    ...
    .addSubcommand((sub) => sub.setName("kesif-ata").setDescription("Ordu süvarilerinden bir hareketli keşif birliği oluşturur")
      .addStringOption((o) => o.setName("ordu").setDescription("Ordunun tam adı veya ID'si").setRequired(true))
      .addIntegerOption((o) => o.setName("hafif-suvari").setDescription("Keşfe ayrılan hafif süvari").setRequired(true).setMinValue(0))
      .addIntegerOption((o) => o.setName("atli-okcu").setDescription("Keşfe ayrılan atlı okçu").setRequired(true).setMinValue(0))
      .addIntegerOption((o) => o.setName("agir-suvari").setDescription("Keşfe ayrılan ağır süvari").setRequired(true).setMinValue(0))
      .addStringOption(countryOption))
    .addSubcommand((sub) => sub.setName("filo-yuku").setDescription("Filonun asker ve kuşatma yükü kapasitesini gösterir")
      .addStringOption((o) => o.setName("filo").setDescription("Filonun tam adı veya ID'si").setRequired(true))
      .addStringOption(countryOption))
    ...
    .addSubcommand((sub) => sub.setName("rota").setDescription("Hedefe en kısa geçilebilir rotayı önizler; emir vermez")
      ...
      .addStringOption((o) => o.setName("birim").setDescription("Ordu/filonun tam adı veya ID'si").setRequired(true))
