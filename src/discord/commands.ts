...
export const commandBuilders = [
  ...
  new SlashCommandBuilder()
    ...
    .addSubcommand((sub) => sub.setName("asker-ekle").setDescription("Yerleşkedeki askerleri orduya tahsis eder")
      ...
      .addStringOption((o) => o.setName("birim").setDescription("Birim türü").setRequired(true).addChoices(...Object.entries(BATTLE_UNIT_STATS).filter(([key]) => key !== "militia").map(([value, unit]) => ({ name: unit.label, value }))))
