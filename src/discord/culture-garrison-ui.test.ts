  ...
  it("sabit garnizon ile seferberlik ordusunu ayrı ve açık başlıklarla gösterir", () => {
    ...
    const document = {
      ...
      settlements: [{
        ...
        unrest_active: false, rebellion_active: false, drought_active: false, famine_active: false,
        bountiful_harvest_active: false, trade_boom_active: false, migration_wave_active: false,
        master_craftsmen_active: false, local_volunteers_active: false, grossIncome: 1_000, payableIncome: 1_000,
